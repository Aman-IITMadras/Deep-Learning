...
CD = os.getcwd()
TRAIN_DIR = os.path.join(CD,'Training Set' ) # Enter File Path of your traning folder, with sub-folders of "Training Set", as provided in Drive, "Checks","Solids","Stripes"
TEST_DIR = os.path.join(CD,'uploads')          # Enter File Path of testing Data.(12 Labeled images Visible in output) (12 images of various kinds,"Solids","Stripes","Checks")
...
for num,data in enumerate(test_data[:]):
    ...
    if np.argmax(model_out) == 3:                         # Label Test images as "Solids", "Checks", "Stripes"
        str_label = 'Solids'
